...
import { CheckCircleOutlined, DashboardOutlined, DownloadOutlined, EyeOutlined, ReloadOutlined, WarningOutlined, FireOutlined } from "@ant-design/icons";
...
export default function EnvironmentWarningPage() {
    ...
    const tabStatistic = (
        <Card title="Top thông số phát sinh cảnh báo">
