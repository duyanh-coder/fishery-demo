...
export default function WaterQuality() {
  ...
  const columns: any = [
    ...
    { title: "Tỉnh/TP", dataIndex: "province", width: 130 },
        ...
        >
          <ReactECharts
            ...
            option={{
              ...
              xAxis: {
                type: "category",
                data: ["Ô Môn", "Thốt Nốt", "Phong Điền", "Long Mỹ", "Ngã Bảy"],
              },
          ...
          series: [
            {
              ...
              type: "line",
              smooth: true,
              data: [7.0, 7.1, 7.2, 7.1, 7.2, 7.3, 7.2],
            },
            {
              name: "DO",
              type: "line",
